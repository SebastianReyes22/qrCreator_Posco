...
<body class="f14">
    ...
    <h1>Generar Etiquetas COMPAS</h1>
    <div class="div-center">
        <div class="div-msg" id="server_answer"></div>
    </div>
    <div class="div-center">
        <form enctype="multipart/form-data" id="load-file">
            <input type="file" id="file-1" name="file-1" acept="xlsx">
            <span class="i f12">Nota: Sólo se permite .xlsx</span>
